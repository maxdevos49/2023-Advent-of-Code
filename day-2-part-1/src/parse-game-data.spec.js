...
describe("parseGameData(data: string): BagGame", () => {
    describe("Example Game 1", () => {
        ...
        it("Should parse the correct game id", () => assert.strictEqual(game.id, expectedId));
        it("Should parse the correct red cubes", () => assert.strictEqual(game.redCubes, expectedRed));
        it("Should parse the correct green cubes", () => assert.strictEqual(game.greenCubes, expectedGreen));
        it("Should parse the correct blue cubes", () => assert.strictEqual(game.blueCubes, expectedBlue));
    });
